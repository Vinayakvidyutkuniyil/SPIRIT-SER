...
module.exports = {
    ...
    AFN: process.env.ALL_CAPTION === undefined ? 'Made By spirit ser' : process.env.ALL_CAPTION,
    ...
    PLK: process.env.OWNER_NAME === undefined ? 'ꪶ͢ɪͥᴛͭsᷤ ͢ᴍͫᴇͤᡃ⃝sᴘɪʀɪᴛ sᴇʀ࿐' : process.env.OWNER_NAME,
    ...
    LOGOSK: process.env.ALL_IMG === undefined ? 'https://i.imgur.com/ZknPTZG.jpeg' : process.env.ALL_IMG,
