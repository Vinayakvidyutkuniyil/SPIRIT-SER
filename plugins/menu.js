...
asena.addCommand({pattern: 'menu', fromMe: false, desc: Lang.WP}, (async (message, match) => {
    ...
    await message.sendMessage(Buffer(respoimage.data), MessageType.image, {mimetype: Mimetype.png, caption: `⛦━━━━━✨sᴘɪʀɪᴛ sᴇʀ ʙᴏᴛ ᴄʀᴇᴀᴛᴇᴅ ʙʏ sᴘɪʀɪᴛ sᴇʀ✨️━━━━━⛦


𝑯𝒆𝒍𝒍𝒐👋 𝑰 𝒂𝒎 𝑺𝑷𝑰𝑹𝑰𝑻 𝑺𝑬𝑹 𝒃𝒐𝒕.
            *ᴄʀᴇᴀᴛᴇᴅ ʙʏ sᴘɪʀɪᴛ sᴇʀ*
